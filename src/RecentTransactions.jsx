...
const RecentTransactions = () => {
  ...
  return (
    <div className="flex flex-col w-[100%] mt-8 border-[1px] border-[#EAECF0] rounded-[5px] max-h-[600px] overflow-y-auto">
      ...
      <div className="min-h-[62px] rounded-t-[5px] flex justify-between items-center pl-6 text-[18px] font-semibold bg-white">
        Recent Transactions
      ...
      <table className="w-[100%] border-collapse border-t border-b border-[#EAECF0] ">
        <thead>
          <tr>
            ...
            <th className="text-left text-[#495057] text-[12px] font-normal border-t border-b border-[#EAECF0] p-2 pl-6 w-[14%]">
              Amount
            </th>
            <th className="text-left text-[#495057] text-[12px] font-normal border-t border-b border-[#EAECF0] p-2 pl-6 w-[10%]">
              Time
            </th>
          </tr>
        </thead>
        ...
        <tbody className="bg-white text-[14px] ">
          {transactions.map((item) => (
            <tr key={item.transaction_id} className="">
              <td className="text-left h-[65px] text-black font-medium border-t border-b border-[#EAECF0] p-2 pl-6 w-[25%]">
                {item.transaction_id}
              </td>
              ...
              <td className="text-left h-[65px] text-[#495057] font-normal border-t border-b border-[#EAECF0] p-2 pl-6 w-[14%]">
                <div
                  className={`${
                    item.amount > 0
              ...
              <td className="text-left h-[65px] text-[#495057] font-normal border-t border-b border-[#EAECF0] p-2 pl-6 w-[10%]">
