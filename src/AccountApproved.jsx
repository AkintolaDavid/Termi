...
export default function AccountApproved() {
  ...
  return (
    <div className="bg-[#155EEF1A] h-[160px] mt-5 rounded-[8px] flex items-center border-[#155EEF1A] border-[1px] ">
      <div className="flex items-start justify-around w-full px-4">
        ...
        {approved ? (
          <div className="flex flex-col w-[700px]">
            ...
            <span className="text-[15px] leading-[15px] mt-[1px]">
            ...
            <button
              ...
              className=" flex rounded-[6px] items-center h-[32px] w-[125px] bg-[#4263EB] justify-center text-white gap-[14px] text-[15px] mt-3"
            >
          ...
          <div className="flex flex-col w-[700px]">
            <span className="text-[18px] text-[#E8590C] font-semibold">
              Your account is pending approval
            </span>
            <span className="text-[14px] leading-[15px] mt-[1px]">
              Your account has been approved and you can now send up to 100
              emails per month. Need more? Order a plan by clicking the upgrade
              button below. The free plan includes 3,000 emails per month.{" "}
            </span>
