    ...
    <div className="bg-[#f8fafc] w-[100%] h-[100%]">
      ...
      <div className="flex justify-between ml-[2.5%] mr-[4%]">
        <Modal isCentered isOpen={isOpen} onClose={onClose}>
          ...
          // boxShadow="lg"
          // width="600px" // Set a maximum width for the modal
          // height="600px"
...
// instead of iframe showing in a modal
// provide full code
// can i get it to show on another page
// i dont wanttoo many  extra comonents
// please answer smartly
